...
import { createTreeDebrisIncident} from '../util/APIUtils';
...
class NewTreeDebrisIncident extends Component {
    constructor(props) {
        super(props);
        this.state = {
            requestNumber: '',
            requestType: 'Tree Debris',
            status: '',
        ...
        this.handleDebrisLocationChange = this.handleDebrisLocationChange.bind(this);
    }
    ...
    handleSubmit(event) {
        ...
        const incidentData = {
            ...
            debrisLocation: this.state.debrisLocation.text
        };

        createTreeDebrisIncident(incidentData)
            .then(response => {
    ...
    handleDebrisLocationChange(event) {
        const value = event.target.value;
        this.setState({
            debrisLocation: {
                text: value,
            ...
            <div className="new-incident-container">
                ...
                <div className="new-incident-content">
                    <Form onSubmit={this.handleSubmit} className="create-incident-form">
                        ...
                        <FormItem validateStatus={this.state.debrisLocation.validateStatus}
                                  help={this.state.debrisLocation.errorMsg} className="incident-form-row">
                        <TextArea
                            placeholder="Enter Debris Location"
                            style = {{ fontSize: '16px' }}
                            autosize={{maxRows: 1 }}
                            name = "Debris Location"
                            value = {this.state.debrisLocation.text}
                            onChange = {this.handleDebrisLocationChange}/>
                        </FormItem>
...
export default NewTreeDebrisIncident;
