...
import {createGarbageCartIncident} from '../util/APIUtils';
...
class NewGarbageCartIncident extends Component {
    constructor(props) {
        super(props);
        this.state = {
            requestNumber: '',
        ...
        this.handleBlackCartsDeliveredChange = this.handleBlackCartsDeliveredChange.bind(this);
    }
    ...
    handleSubmit(event) {
        ...
        const incidentData = {
            ...
            blackCartsDelivered: this.state.blackCartsDelivered.float,
        };

        createGarbageCartIncident(incidentData)
            .then(response => {
    ...
    handleBlackCartsDeliveredChange(event) {
        const value = event.target.value;
        this.setState({
            blackCartsDelivered: {
                float: value,
            ...
            <div className="new-incident-container">
                ...
                <div className="new-incident-content">
                    <Form onSubmit={this.handleSubmit} className="create-incident-form">
                        ...
                        <FormItem validateStatus={this.state.blackCartsDelivered.validateStatus}
                                  help={this.state.blackCartsDelivered.errorMsg} className="incident-form-row">
                        <TextArea
                            placeholder="Enter number of Black Carts Delivered"
                            style = {{ fontSize: '16px' }}
                            autosize={{maxRows: 1 }}
                            name = "Black Carts Delivered"
                            value = {this.state.blackCartsDelivered.float}
                            onChange = {this.handleBlackCartsDeliveredChange}/>
                        </FormItem>
...
export default NewGarbageCartIncident;
