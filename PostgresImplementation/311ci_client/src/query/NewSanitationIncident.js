...
import { createSanitationIncident} from '../util/APIUtils';
...
class NewSanitationIncident extends Component {
    constructor(props) {
        super(props);
        this.state = {
            requestNumber: '',
        ...
        this.handleCodeViolationChange = this.handleCodeViolationChange.bind(this);
    }
    ...
    handleSubmit(event) {
        ...
        const incidentData = {
            ...
            codeViolationNature: this.state.codeViolationNature.text
        };

        createSanitationIncident(incidentData)
            .then(response => {
    ...
    handleCodeViolationChange(event) {
        const value = event.target.value;
        this.setState({
            codeViolationNature: {
                text: value,
            ...
            <div className="new-incident-container">
                ...
                <div className="new-incident-content">
                    <Form onSubmit={this.handleSubmit} className="create-incident-form">
                        ...
                        <FormItem validateStatus={this.state.codeViolationNature.validateStatus}
                                  help={this.state.codeViolationNature.errorMsg} className="incident-form-row">
                        <TextArea
                            placeholder="Enter Code Violation Nature"
                            style = {{ fontSize: '16px' }}
                            autosize={{maxRows: 1 }}
                            name = "Code Violation"
                            value = {this.state.codeViolationNature.text}
                            onChange = {this.handleCodeViolationChange} />
                        </FormItem>
...
export default NewSanitationIncident;
