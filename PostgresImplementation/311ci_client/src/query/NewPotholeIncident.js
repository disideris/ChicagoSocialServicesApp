...
import {createPotholeIncident} from '../util/APIUtils';
...
class NewPotholeIncident extends Component {
    constructor(props) {
        super(props);
        this.state = {
            requestNumber: '',
            requestType: 'Pot Hole in Street',
            status: '',
        ...
        this.handlePotholesFilledChange = this.handlePotholesFilledChange.bind(this);
    }
    ...
    handleSubmit(event) {
        ...
        const incidentData = {
            ...
            potholesFilled: this.state.potholesFilled.float,
        };

        createPotholeIncident(incidentData)
            .then(response => {
    ...
    handlePotholesFilledChange(event) {
        const value = event.target.value;
        this.setState({
            potholesFilled: {
                float: value,
            ...
            <div className="new-incident-container">
                ...
                <div className="new-incident-content">
                    <Form onSubmit={this.handleSubmit} className="create-incident-form">
                        ...
                        <FormItem validateStatus={this.state.potholesFilled.validateStatus}
                                  help={this.state.potholesFilled.errorMsg} className="incident-form-row">
                        <TextArea
                            placeholder="Enter number of Potholes filled"
                            style = {{ fontSize: '16px' }}
                            autosize={{maxRows: 1 }}
                            name = "Potholes Filled"
                            value = {this.state.potholesFilled.float}
                            onChange = {this.handlePotholesFilledChange}/>
                        </FormItem>
...
export default NewPotholeIncident;
