...
import {createGraffitiIncident} from '../util/APIUtils';
...
class NewGraffitiIncident extends Component {
    constructor(props) {
        super(props);
        this.state = {
            requestNumber: '',
        ...
        this.handleGraffitiSurfaceChange = this.handleGraffitiSurfaceChange.bind(this);
        this.handleGraffitiLocationChange = this.handleGraffitiLocationChange.bind(this);
    }
    ...
    handleSubmit(event) {
        ...
        const incidentData = {
            ...
            graffitiSurface: this.state.graffitiSurface.text,
            graffitiLocation: this.state.graffitiLocation.text
        };

        createGraffitiIncident(incidentData)
        .then(response => {
    ...
    handleGraffitiSurfaceChange(event) {
        const value = event.target.value;
        this.setState({
            graffitiSurface: {
                text: value,
    ...
    handleGraffitiLocationChange(event) {
        const value = event.target.value;
        this.setState({
            graffitiLocation: {
                text: value,
            ...
            <div className="new-incident-container">
                ...
                <div className="new-incident-content">
                    <Form onSubmit={this.handleSubmit} className="create-incident-form">
                        ...
                        <FormItem validateStatus={this.state.graffitiSurface.validateStatus}
                            help={this.state.graffitiSurface.errorMsg} className="incident-form-row">
                        <TextArea
                            placeholder="Enter Graffiti Surface"
                            style = {{ fontSize: '16px' }}
                            autosize={{maxRows: 1 }}
                            name = "Graffiti Surface"
                            value = {this.state.graffitiSurface.text}
                            onChange = {this.handleGraffitiSurfaceChange} />
                        </FormItem>
                        <FormItem validateStatus={this.state.graffitiLocation.validateStatus}
                            help={this.state.graffitiLocation.errorMsg} className="incident-form-row">
                        <TextArea
                            placeholder="Enter Graffiti Location"
                            style = {{ fontSize: '16px' }}
                            autosize={{maxRows: 1 }}
                            name = "Graffiti Location"
                            value = {this.state.graffitiLocation.text}
                            onChange = {this.handleGraffitiLocationChange} />
                        </FormItem>
...
export default NewGraffitiIncident;
